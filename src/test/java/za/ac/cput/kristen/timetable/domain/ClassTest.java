...
public class ClassTest
{
    ...
    {
        stud1 = new Student.Builder(Long.valueOf(1234), "Tristan", "Bro").creditsEarned(70).build();
        stud2 = new Student.Builder(Long.valueOf(5678), "Mandy", "Mo").courseYear(2).creditsEarned(20).build();
